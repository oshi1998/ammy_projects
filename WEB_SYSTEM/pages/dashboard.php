...
<head>
    ...
    <script>
        function loadDashboard() {
            $.ajax({
                type: "get",
                url: "../services/dashboard/read.php"
            }).done(function(res){
                console.log(res);
                $('#num_adm').text(res.data['num_adm']);
                $('#num_mem').text(res.data['num_mem']);
                $('#num_type').text(res.data['num_type']);
                $('#num_att').text(res.data['num_att']);
            }).fail(function(res){
                console.log(res);
            });
        }
...
<body class="hold-transition sidebar-mini" onload="loadDashboard()">
    <div class="wrapper">
